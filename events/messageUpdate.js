...
module.exports = async (oldMessage, newMessage) => {
  ...
  if (!isBot(user) && !isAdmin(user)) {
    ...
    const embed = new EmbedBuilder()
      ...
      .setURL(`https://discord.com/channels/${guildID}/${newMessage.channel.id}/${newMessage.id}`)
      .addFields(
    ...
    if (oldContent) {
      ...
      embed.addFields({ name: "До изменения:", value: oldContent, inline: false });
    }
    ...
    embed.addFields({ name: "После изменения:", value: newContent, inline: false });
